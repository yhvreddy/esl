...
class DefaultModel extends Model
{
	...
	*	Login User Details
	* */
	public function logindetails($request)
	{
		return DB::table('esl_users')->where('id',$request)->get();
	}
	...
	*/
	...
	{
		$data = DB::table($tablename)->select($selectdata)->where($conduction)->orderBy('id','DESC')->get();
		return $data;
	}
